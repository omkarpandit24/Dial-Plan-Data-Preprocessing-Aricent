...
#Import Working Hours Execution data
...
#Call of service codes for working hours execution
...
execution_cycle = 'Working Hours Execution'
...
data3.loc[data3['Calling_Party'] == 'CLIRINTLWhrENH']
...
data4.to_csv('PP_INTLENH_premium_Whrs_try2_CT_3.csv')
